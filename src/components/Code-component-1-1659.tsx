...
export function FlowerSurprise({ onVideoReveal }: FlowerSurpriseProps) {
        ...
        {showVideo && (
          ...
          >
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-dusty-rose to-soft-gold flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="font-body text-xl">Your special video would play here</p>
                  <p className="font-body text-sm mt-2 opacity-75">Click X to continue</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
