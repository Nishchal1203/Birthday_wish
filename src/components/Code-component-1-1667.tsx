    ...
    <div className="min-h-screen bg-creamy-white flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="text-center mb-16 relative z-10">
        ...
        <motion.div 
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: playingMusic ? 1 : 0 }}
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="absolute inset-8 flex items-center justify-center">
            <motion.p 
              className="font-script text-charcoal-grey text-xl md:text-2xl text-center leading-relaxed"
              initial={{ opacity: 0 }}
            ...
            >
              <motion.span
                initial={{ width: 0 }}
                animate={showParchment ? { width: "100%" } : {}}
                transition={{ duration: 3, delay: 1 }}
                className="inline-block overflow-hidden whitespace-nowrap border-r-2 border-charcoal-grey animate-blink"
                style={{ 
                  animation: showParchment ? "typewriter 3s steps(50) 1s 1 normal both, blink 1s step-end infinite" : "none"
                }}
              >
                {personalMessage}
              </motion.span>
